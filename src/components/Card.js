  ...
  return (
    <div className='group17'>
        <div className='group15'>
            ...
            {!darkTheme ?  <p className='text1'>keyboard</p> : <p className='text17'>keyboard</p>}
            ...
            <div className='group11'>
                ...
                <div className='group6'>
                    <div className='group3'>
                        ...
                        {!darkTheme ? <p className='text5'>(etc.) A set of keys used to operate a typewriter, computer etc.</p> :
